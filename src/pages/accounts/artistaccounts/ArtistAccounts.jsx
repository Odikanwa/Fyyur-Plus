...
const ArtistAccounts = () => {
  const images = {
    profilePic: require("../../../img/Phyno.jpg"),
  };
  return (
    <Container>
      <Header />
      <HeroDiv>
        <ProfilePicImg
          ...
          style={{ height: "140px", width: "140px", borderRadius: "30%" }}
        />
        <Name>Phyno</Name>
        <TopButtonsDiv>
          <TopButton
        ...
        <PersonalSectionWrapper>
          ...
          <ProfileDiv>
            ...
            <AboutMeList>
              ...
              <Desc>PhynoEzege</Desc>
              <ListTitle>Email</ListTitle>
              <Desc>notrealphynoezege@gmail.com</Desc>
              <ListTitle>Lives in</ListTitle>
              <Desc>Enugu, Nigeria</Desc>
            </AboutMeList>
          </ProfileDiv>
          <IconTextDropdownDiv>
            <IconTextDiv>
          ...
          <IconTextDropdownDiv>
            <IconTextDiv>
              <MdAddToQueue style={{ height: "35px", width: "35px" }} />
              <Title> Shows </Title>
            </IconTextDiv>
            <MdOutlineChevronRight
              style={{ height: "35px", width: "35px", color: "#ff0800" }}
