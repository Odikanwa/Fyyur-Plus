  ...
  return (
    <Container>
      ...
      <SpecTextDiv>
        ...
        <IconTextDiv
          style={{ paddingLeft: "0px", justifyContent: "space-between" }}
        >
      ...
      <Desc>
        ...
        commodo consequat...<TextSpan>show more</TextSpan>
      </Desc>
      <Title> Need a Map? </Title>
      <MapDiv>
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.746682566303!2d3.4279245147702264!3d6.42658279535034!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103bf53aec4dd92d%3A0x5e34fe6a84cddd53!2sEko%20Hotels%20%26%20Suites!5e0!3m2!1sen!2sng!4v1661452118417!5m2!1sen!2sng"
          title="google-map"
          width="100%"
          height="100%"
      ...
      <IconTextDiv style={{ justifyContent: "space-between" }}>
        ...
        <Text
          style={{ color: "brown", fontWeight: "bold", marginRight: "20px" }}
        >
          {" "}
          See all &#129122;{" "}
        </Text>
      ...
      <RatingsDiv>
        <Text style={{ fontSize: "35px", fontWeight: "bold", color: "gold" }}>
          {" "}
          4.7/5{" "}
        </Text>
      ...
      <RatingsBarDiv>
        <IconTextDiv style={{ justifyContent: "space-between" }}>
          <Text
            style={{ fontSize: "22px", fontWeight: "bold", wordSpacing: "2px" }}
          >
            <>
              {" "}
